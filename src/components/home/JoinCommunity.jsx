...
import joinImg from "../../assets/join-community/join-img.png";
import joinBg from "../../assets/join-bg.png";

const JoinCommunity = () => {
  return (
    <section className='py-8 md:py-12 px-4 md:px-10'>
      <div className='relative! overflow-hidden container flex flex-col md:flex-row gap-4 text-start items-center justify-betweeen text-white rounded-xl md:rounded-3xl pt-8 md:pt-4 p-4 md:px-12'>
        ...
        <img src={joinImg} alt='' className='h-fit ml-auto w-full md:w-80 object-cover rounded-2xl shadow-lg z-4' />
      </div>
    </section>
  )
}
